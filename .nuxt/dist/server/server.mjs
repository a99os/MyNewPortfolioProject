...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/about-hDS66sd8.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index-3_MpMyX_.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/_id_-kMSkI7Rv.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index-7dx1tViU.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  custom: () => import("./_nuxt/custom-MsQ5a3OR.js").then((m) => m.default || m),
  default: () => import("./_nuxt/default-08Q4393l.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-lo0KP5-Z.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-2M_YDXhE.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-pp1y8-_3.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
